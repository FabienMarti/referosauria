...
<main>
    <section class="container-fluid mt-4">
        <div class="row justify-content-around">
            ...
            <!--Presentation Dino-->
            <div class="col-md-6 border border-dark divBackColor p-5">
                ...
                foreach ($showLatestCreatureInfos as $crea) { ?>
                    <div class="mt-1 p-3 row border border-dark divBackColor">
                        <div class="col-md-4 text-center my-auto">
                            <img class="img-fluid titleStyle border border-dark" style="width: 50%" src="<?= $crea->miniImage ?>" alt="tête de <?= $crea->name ?>" title="<?= $crea->name ?>" />
                        </div>
