<h1 class="text-center titleStyleShadow my-3"><u>La Paléonthologie</u></h1>
<div class="row justify-content-around">
    <div class="col-md-5 border border-dark rounded divBackColor">
        ...
        <ul>
            <li class="ml-5"><strong>paleo</strong>, de παλαιός, palaios, "ancien"</li>
            <li class="ml-5"><strong>ontos</strong>, de ὄντος, participe-présent du verbe être : « étant »</li>
            <li class="ml-5"><strong>logie</strong>, de λόγος, logos, "l'étude, le discours"</li>
        </ul>
        <p>Il s'agit donc, littéralement, de la « science étudiant la vie ancienne » et, plus précisément, de la discipline qui étudie les organismes disparus ayant laissé dans les terrains sédimentaires des restes de leur corps ou des traces de leurs activités. Ces restes ou traces sont appelés fossiles.
    ...
    <div class="col-md-5 border border-dark rounded divBackColor">
        ...
        <p>Lors de leurs analyses, les paléontologues tiennent toujours compte de plusieurs principes dont l'un d'eux, l'actualisme, stipule que les lois physiques et biologiques de l'époque étaient les mêmes qu'à ce jour.</p>
        <p class="text-right">Source : <a href="https://www.futura-sciences.com/planete/definitions/paleontologie-paleontologie-11866/">Futura-sciences</a></p>
    </div>
</div>
